...
func CreateEventForNodes_tx(ctx context.Context, tx pgx.Tx, nodeIds []uuid.UUID,
	content types.ClusterEventContent, payload any, target types.ClusterEventTarget) error {
...
func createEventsForOtherNodes_tx(ctx context.Context, tx pgx.Tx, content types.ClusterEventContent, payload any, target types.ClusterEventTarget) error {
