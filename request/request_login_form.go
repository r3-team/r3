...
func LoginFormDel_tx(ctx context.Context, tx pgx.Tx, reqJson json.RawMessage) (any, error) {
	var req uuid.UUID
...
func LoginFormSet_tx(ctx context.Context, tx pgx.Tx, reqJson json.RawMessage) (any, error) {
