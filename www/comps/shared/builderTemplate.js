import { isAttributeBoolean, isAttributeRelationship } from './attribute.js';
import { getUuidV4 } from './crypto.js';
import { getTemplateArgs, getTemplateFnc, getTemplateReturn } from './templates.js';
...
export function getTemplateFieldMap() {
	return {
		id: getUuidV4(),
		iconId: null,
		content: 'map',
