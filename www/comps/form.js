	...
	computed:{
		...
		exposedFunctions:(s) => {
			return {
				...
				// field manipulation
				get_field_file_link:(fieldId, fileId, filename) => s.fieldIdMapData[fieldId] === undefined
					? undefined : s.getAttributeFileHref(s.fieldIdMapData[fieldId].attributeId, fileId, filename, s.token),
				get_field_file_link_version:(fieldId, fileId, filename, version) => s.fieldIdMapData[fieldId] === undefined
					? undefined : s.getAttributeFileVersionHref(s.fieldIdMapData[fieldId].attributeId, fileId, filename, version, s.token),
