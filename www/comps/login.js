...
import { aesGcmExportBase64, getRandomString, pbkdf2PassToAesGcmKey } from './shared/crypto.js';
import { consoleError } from './shared/error.js';
import { getLineBreaksParsedToHtml, openLink } from './shared/generic.js';
						...
						as => {
							...
							oauth.calculatePKCECodeChallenge(verifier).then(
								challenge => {
									...
									const scopes = JSON.parse(JSON.stringify(c.scopes));
